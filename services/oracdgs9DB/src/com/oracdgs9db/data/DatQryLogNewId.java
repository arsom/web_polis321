...
/**
 *  oracdgs9DB.DatQryLogNewId
 *  10/26/2555 14:17:40
 * 
 */
public class DatQryLogNewId
    implements Serializable
{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatQryLogNewId)) {
            return false;
        }
        DatQryLogNewId other = ((DatQryLogNewId) o);
        if (this.userId == null) {
        ...
        if (this.qryGroup == null) {
            if (other.qryGroup!= null) {
                return false;
            }
        } else {
            if (!this.qryGroup.equals(other.qryGroup)) {
                return false;
            }
        }
        if (this.qrySource == null) {
            if (other.qrySource!= null) {
                return false;
            }
        } else {
            if (!this.qrySource.equals(other.qrySource)) {
                return false;
            }
        }
        if (this.ipAddr == null) {
    ...
    public int hashCode() {
        ...
        rtn = (rtn* 37);
        if (this.qryGroup!= null) {
            rtn = (rtn + this.qryGroup.hashCode());
        }
        rtn = (rtn* 37);
        if (this.qrySource!= null) {
            rtn = (rtn + this.qrySource.hashCode());
        }
        rtn = (rtn* 37);
        if (this.ipAddr!= null) {
